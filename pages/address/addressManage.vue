	...
	export default {
		data() {
			return {
				addressData: {
					...
					area: '',
					default: false,
					key:Math.floor(Math.random()*12121)
				}
			}
		},
		onLoad(option) {
		...
		methods: {
			...
			confirm() {
                ...
                let addressList = uni.getStorageSync('ADDRESS_INFO') || []
				if (this.manageType == 'edit') {
					
				 let editIndex=addressList.findIndex((v)=>v.key==this.addressData.key)
				  addressList[editIndex] =this.addressData
