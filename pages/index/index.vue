  ...
  <view class="container">
    ...
    <view class="cate-section">
      <view class="cate-item" v-for="brand in brandList" :key="brand._id">
        <image :src="brand.logoFilePath" />
        <text>{{ brand.name }}</text>
      </view>
    </view>
    <view class="ad-1">
      <image src="/static/temp/ad.jpeg" mode="scaleToFill" />
    </view>
    <!-- 秒杀楼层 -->
    <view class="seckill-section m-t">
      ...
      <scroll-view class="floor-list" scroll-x>
        <view class="scoll-wrapper">
          <view v-for="(seckill, index) in seckillList" :key="index" class="floor-item" @click="navToDetailPage(seckill)">
            <image :src="seckill.designSketch[0]" mode="aspectFill" />
    ...
    <view class="group-section">
      <swiper class="g-swiper" :duration="500">
        <swiper-item class="g-swiper-item" v-for="(item, index) in groupBuyingList" :key="index" @click="navToDetailPage(item)">
          <view class="g-item left">
            <image :src="item.designSketch[0]" mode="aspectFill" />
            <view class="t-box">
          ...
          <view class="g-item right">
            <image :src="item.designSketch[1] || item.designSketch[0]" mode="aspectFill" />
            <view class="t-box">
...
<script>
import { getGoodsBrand, getGoodsTypeList } from "@/api/home.js";
const carouselList = [
  {
